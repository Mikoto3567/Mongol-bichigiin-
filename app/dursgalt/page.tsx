...
export default function DursgaltPage() {
  const monuments = [
    { id: 1, img: "/image/1.jpg", title: "Гүюг хааны хариу захиа", desc: "1246 онд Ромын папад Гүюг хааны илгээсэн хариу захидал." },
    { id: 2, img: "/image/2.jpg", title: "Гүюг хааны тамганы бичээс", desc: "1246-1248 оны Гүюг хааны тамганы дардас, бичээс." },
    { id: 3, img: "/image/3.jpg", title: "Монгол хэлээр бичсэн дурсгал", desc: "13-14-р зууны монгол хэлээр бичсэн ерөөлийн бичээс." },
    ...
    { id: 5, img: "/image/5.jpg", title: "Их Төрийн нэвтрэх эрдэнэ", desc: "Хайсан хүлэг хааны цутгуулсан мөнгөн зоос." },
    { id: 6, img: "/image/6.jpg", title: "Аргун хааны захидал", desc: "Аргун хаанаас Францын IV Филипп-д бичсэн захидал." },
    { id: 7, img: "/image/7.jpg", title: "Жигүнтэй даргачийн хөшөө", desc: "1338 онд босгосон Жигүнтэй даргачийн бичигт хөшөө." },
        ...
        {monuments.map((item, index) => (
          <div key={item.id} className={`flex flex-col md:flex-row items-center gap-8 p-6 bg-[#f5efe6] rounded-2xl shadow-md border border-[#d4c3b0] ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
            <div className="w-full md:w-1/2 overflow-hidden rounded-xl border-2 border-[#998a7d]">
              <img src={item.img} alt={item.title} className="w-full h-64 object-contain bg-white hover:scale-110 transition-transform duration-500" />
            </div>
